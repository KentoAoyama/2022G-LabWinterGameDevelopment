...
{
    [Tooltip("プレイヤーの座標")] protected Transform _playerTransform;
    [Tooltip("移動するかどうかの距離")] protected float _moveDistance = 5.0f;
    [Tooltip("移動の速さ")] protected float _moveSpeed = 3.0f;
    [Tooltip("攻撃できるかどうかの距離")] private float _attackDistance = 3.0f;
